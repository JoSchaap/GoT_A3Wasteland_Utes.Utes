...
_vehicleClass = ["O_Ifrit_GMG_F","B_Hunter_HMG_F","B_Hunter_RCWS_F","O_Ifrit_MG_F","GAZ_Vodnik_HMG","GAZ_Vodnik","HMMWV_M2","HMMWV_Armored","HMMWV_MK19","ArmoredSUV_PMC","HMMWV_Ambulance","GAZ_Vodnik_MedEvac"] call BIS_fnc_selectRandom;
